...
if (!$user_id) {
    header('Location: index.php?action=karyawan');
    exit;
}

// Simulasi data pengguna (biasanya dari database)
...
$user_data = [
    ...
    'username' => 'johndoe',
    'role' => 'karyawan',
    'availability_time' => 'Senin - Jumat, 08:00 - 16:00'
];
?>
...
<head>
    ...
    <title>Edit Pengguna - Sistem Perkebunan</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-4 lg:p-8">
            ...
            <div class="mb-8">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Data Pengguna</h1>
                    <p class="text-gray-600">Perbarui informasi pengguna dalam sistem manajemen perkebunan</p>
                </div>
            </div>

            <!-- Alert Success/Error (if any) -->
                ...
                <div class="max-w-2xl mb-6">
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="font-medium text-green-900 mb-1">Berhasil</h4>
            ...
            <div class="max-w-2xl">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <form method="POST" action="?action=karyawan-update&id=<?php echo $user_data['id']; ?>" class="space-y-6">
                            <!-- Name Field -->
                            <div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        ...
                                        <option value="karyawan" <?php echo $user_data['role'] === 'karyawan' ? 'selected' : ''; ?>>Karyawan</option>
                                    </select>
                            ...
                            <!-- Availability Field -->
                            <div id="availability-section" class="<?php echo $user_data['role'] !== 'karyawan' ? 'hidden' : ''; ?>">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea 
                                        ...
                                        rows="3"
                                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors duration-200 placeholder-gray-400 resize-none"
                                        placeholder="Contoh: Senin - Jumat, 08:00 - 16:00"
                                    ><?php echo htmlspecialchars($user_data['availability_time'] ?? ''); ?></textarea>
                                </div>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-start gap-3">
                        <i data-feather="user" class="w-5 h-5 text-blue-500 mt-0.5"></i>
                        <div>
                            <h4 class="font-medium text-blue-900 mb-1">Informasi Pengguna</h4>
                            <div class="text-sm text-blue-700 space-y-1">
                                <p><strong>ID:</strong> <?php echo $user_data['id']; ?></p>
                                <p><strong>Dibuat:</strong> 15 Januari 2024</p>
                                <p><strong>Terakhir Login:</strong> 2 hari yang lalu</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-medium text-yellow-900 mb-1">Perhatian</h4>
                            <p class="text-sm text-yellow-700">
                                Perubahan pada role pengguna akan mempengaruhi hak akses mereka. Pastikan untuk 
                                memberitahukan pengguna tentang perubahan yang dilakukan.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!name || !email || !username || !role) {
                e.preventDefault();
                alert('Field nama, email, username, dan role wajib diisi!');
                return;
            }
